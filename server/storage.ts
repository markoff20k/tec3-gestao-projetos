...
export class MemStorage implements IStorage {
  ...
  private async seedData() {
    ...
    const client1: Client = {
      ...
      emailComercial: 'joao.silva@abctech.com',
      telefoneComercial: '(11) 99999-0001',
      nomeMedicao: null,
      emailMedicao: null,
      telefoneMedicao: null,
      nomeTecnico: 'Carlos Santos',
      emailTecnico: 'carlos.santos@abctech.com',
      telefoneTecnico: '(11) 99999-0002',
      isActive: true,
    };
    ...
    const client2: Client = {
      ...
      razaoSocial: 'XYZ Industrias S/A',
      nomeFantasia: 'XYZ',
      pais: 'Brasil',
      cep: '04543-011',
      rua: 'Rua Funchal',
      ...
      cidade: 'São Paulo',
      estado: 'SP',
      nomeComercial: 'Maria Oliveira',
      emailComercial: 'maria@xyz.com.br',
      telefoneComercial: '(11) 88888-0001',
      nomeMedicao: 'Pedro Rocha',
      emailMedicao: 'pedro@xyz.com.br',
      telefoneMedicao: '(11) 88888-0002',
      nomeTecnico: null,
      emailTecnico: null,
  ...
  async createClient(insertClient: InsertClient): Promise<Client> {
    ...
    const client: Client = { 
      ...insertClient, 
      id,
      cnpj: insertClient.cnpj ?? null,
      nomeFantasia: insertClient.nomeFantasia ?? null,
      pais: insertClient.pais ?? null,
      cep: insertClient.cep ?? null,
      rua: insertClient.rua ?? null,
      numero: insertClient.numero ?? null,
      complemento: insertClient.complemento ?? null,
      bairro: insertClient.bairro ?? null,
      cidade: insertClient.cidade ?? null,
      estado: insertClient.estado ?? null,
      nomeComercial: insertClient.nomeComercial ?? null,
      emailComercial: insertClient.emailComercial ?? null,
      telefoneComercial: insertClient.telefoneComercial ?? null,
      nomeMedicao: insertClient.nomeMedicao ?? null,
      emailMedicao: insertClient.emailMedicao ?? null,
      telefoneMedicao: insertClient.telefoneMedicao ?? null,
      nomeTecnico: insertClient.nomeTecnico ?? null,
      emailTecnico: insertClient.emailTecnico ?? null,
      telefoneTecnico: insertClient.telefoneTecnico ?? null,
